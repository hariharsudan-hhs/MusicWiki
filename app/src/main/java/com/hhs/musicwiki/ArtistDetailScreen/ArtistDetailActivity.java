...
public class ArtistDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<Artist> artistInfoCall = lastFmApi.getArtistInfo(getString(R.string.artist_getinfo), artistName, getString(R.string.api_key), getString(R.string.json));
        getArtistInfo(artistInfoCall);

        Call<ArtistTopTracks> topTracksCall = lastFmApi.getArtistTopTracks(getString(R.string.artist_gettoptracks), artistName, getString(R.string.api_key), getString(R.string.json));
        getArtistTopTracks(topTracksCall);

        Call<ArtistTopAlbums> topAlbumsCall = lastFmApi.getArtistTopAlbums(getString(R.string.artist_gettopalbums), artistName, getString(R.string.api_key), getString(R.string.json));
